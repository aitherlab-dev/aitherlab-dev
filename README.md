...
i'm a videographer with zero programming background. at 47, i decided to build real software — entirely with AI.

**aither flow** is my first project. takes Claude Code out of the terminal and into a real desktop app.
...
custom skills with a clear workflow — not just a cryptic /skill that nobody understands what it does.
